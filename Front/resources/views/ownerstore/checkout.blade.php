        ...
        <div class="container p-12 mx-auto">
            <div class="flex flex-col w-full px-0 mx-auto md:flex-row">
                <div class="flex flex-col md:w-full">
                    <h2 class="mb-4 font-bold md:text-xl text-heading ">Shipping Information
                    </h2>
                    <form class="justify-center w-full mx-auto" method="post" action>
                        <div class="">
                            ...
                            <div class="mt-4">
                                <h2 class="mb-2 font-bold md:text-xl text-heading ">Payment Information
                                </h2>
                                <div class="inline-flex items-center">
                                    <span class="block mb-3 text-sm font-semibold text-gray-500">Payment Type</span>
                                    <div class="mt-8"><br>
                                ...
                                <div class="w-full">
                                    <label for="Email"
                                        class="block mb-3 text-sm font-semibold text-gray-500">Name on card</label>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="w-full">
                                    <label for="Email"
                                        class="block mb-3 text-sm font-semibold text-gray-500">Card Number</label>
                                    <input name="Last Name" type="text" placeholder=""
                                        class="w-full px-4 py-3 text-sm border border-gray-300 rounded lg:text-sm focus:outline-none focus:ring-1 focus:ring-blue-600">
                                </div>
                            </div>
                            <div class="mt-4">
                                <div class="w-full">
                                    <label for="Email"
                                                class="block mb-3 text-sm font-semibold text-gray-500">Expiration date</label>
                                    <div class="space-x-0 lg:flex lg:space-x-4">
                                        
                                        <div class="w-full lg:w-1/2">
                                            <label for="city"
                                                class="block mb-3 text-sm font-semibold text-gray-500">Month</label>
                            ...
                            <a href="/email"
                            class="w-full px-6 py-2 flex items-center justify-center  text-blue-200 bg-blue-600 hover:bg-blue-900">Confirm Payment</a>
                        </div>
                    </form>
                </div>
