  ...
  <div class="container mx-auto p-5">
    ...
    <div class="md:flex md:flex-row mt-20">
      <div class="md:w-2/5 flex flex-col justify-center items-center">
        ...
        <p class="uppercase text-gray-600 tracking-wide text-center md:self-start md:text-left">Your brand tagline goes here.</p>
        <p class="uppercase text-gray-600 tracking-wide text-center md:self-start md:text-left">Your brand motto goes here.</p>
    ...
    <div class="grid grid-flow-row grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <div class="font-extrabold">U$14.00</div>
      ...
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <h3 class="font-extrabold">U$30.00</h3>
      ...
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <h3 class="font-extrabold">U$50.00</h3>
      ...
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <h3 class="font-extrabold">U$45.22</a></h3>
          </div>
    ...
    <div class="grid grid-flow-row grid-cols-1 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <h3 class="font-extrabold">U$19.43</h3>
          </div>
      ...
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <h3 class="font-extrabold">U$38.43</h3>
          </div>
      ...
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <h3 class="font-extrabold">U$46.43</h3>
          </div>
          {{-- <div class="flex flex-row my-3">
      ...
      <div class="shadow-lg rounded-lg">
        ...
        <div class="p-5">
          ...
          <div class="flex flex-row my-3">
            <h3 class="font-extrabold">U$29.00</h3>
          </div>
