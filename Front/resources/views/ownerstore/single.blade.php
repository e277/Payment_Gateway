        ...
        <section class="text-gray-700 body-font overflow-hidden bg-white">
            ...
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                ...
                <div class="flex">
                    ...
                    <a href="" class="flex ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-black rounded">Add to cart</a>
                    <a href="" class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-black rounded">Buy now</a>
                </div>
                </div>
            </div>
            </div>
